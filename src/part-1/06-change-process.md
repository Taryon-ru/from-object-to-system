...
Центральным документом является ГОСТ Р 2.503-2023 «Единая система конструкторской документации. Правила внесения изменений». Стандарт устанавливает, что изменение в конструкторскую документацию вносится на основании извещения об изменении.
