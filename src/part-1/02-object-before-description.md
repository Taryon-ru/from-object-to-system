...
<div class="main-question">
       <strong>Главный вопрос:</strong>
        может ли информационная система представить объект, у которого ещё нет ни одного документа?
</div>

#### 2.1. Разговор, который происходит каждый день

На любом промышленном предприятии регулярно происходит один и тот же разговор. Руководитель собирает совещание и говорит: «Мы начинаем разработку нового насоса для магистральных трубопроводов».
