...
#### Тип и экземпляр: различие, которое кажется очевидным
...
#### Почему экземпляр не является Revision
...
#### Почему экземпляр нельзя отождествлять с результатом конфигурирования
...
#### Почему экземпляр не является вариантом
...
#### Экземпляр как точка трассируемости
...
#### Применённое описание и экземпляр
