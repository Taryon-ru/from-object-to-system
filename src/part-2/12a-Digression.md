...
### Глава 12а. Почему в книге нет электронной структуры изделия
...
#### 12а.3 Почему в бумажной документации нет «полной спецификации»
...
#### 12а.3 А что значит утвердить полную ЭСК?
...
#### 12а.4 Комплект документации решает эту задачу иначе
...
#### 12а.5 Структура изделия как совокупность "малых структур"
...
Это не недостаток бумажного мира. Это правильная инженерная логика: **структура изделия определяется совокупностью спецификаций, каждая из которых зафиксирована самостоятельно**.

#### 12а.6 Электронный мир сохраняет ту же логику

Переход к электронной форме не должен менять эту логику.

Каждое определение структуры — каждая «малая структура» — остаётся самостоятельным электронным документом - основной ЭСК. Его можно согласовать. Утвердить. Изменить. Отменить. У него есть собственный жизненный цикл.
...
взять все основные ЭСК и представить их как единое дерево. Не создавая новый документ. Не превращая самостоятельные документы в один документ-матрёшку - полная ЭСК. Просто **вычислив представление** на основе связей между самостоятельными документами.
...
#### 12а.7 Где именно ломается ГОСТ Р 2.053
...
#### 12а.8 Что значит утвердить ЭСК в этой модели
...
#### 12а.9 Почему в этой книге нет ЭСИ как фундаментального понятия
...
**объекты → отношения → структуры (основная ЭСК) → совокупность (основных ЭСК) = полная структура изделия**

а не:

**один документ «полная ЭСК», включающий другие документы.**

Это позволяет работать со структурой изделия как с единым целым, не превращая самостоятельные документы в матрёшку.
