...
<div class="main-question">
       <strong>Главный вопрос:</strong>
        что должна сделать система с объектом, когда его существование заканчивается, и почему «объект больше не существует» не означает «объекта никогда не существовало»?
